                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-amber-700 dark:text-amber-400 mb-3 flex items-center">
                      <i className="fas fa-sword mr-2"></i>アタッカー
                    </h3>
                    <div className="flex flex-wrap gap-3">
                      {attackers.length > 0 ? attackers.map((character) => (
                        <Link 
                          ...
                          className="relative bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg border border-amber-100 dark:border-amber-900/30 w-20 sm:w-24 transition-all duration-300 hover:-translate-y-1 cursor-pointer"
                        >
                          <div className="relative h-20 sm:h-24">
                            ...
                            {tierMode === 'c2r1' && (
                              <div className="absolute top-0 left-0 m-1">
                                <span className="flex items-center justify-center w-5 h-5 rounded-full bg-amber-600 text-white font-bold text-xs">
                                  2
                                </span>
                              </div>
                            )}
